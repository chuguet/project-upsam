...
/**
 * The Class AntecedentesPersonalesPCIDTO.
 */
public class AntecedentesPersonalesPCIDTO extends AbstractDTO {
	 ...
	 */
	public Integer getAyudasMarcha() {
		return ayudasMarcha;
	}
	 ...
	 */
	public Integer getOrtesisDiurna() {
	...
	/**
	 * Gets the terapia ocupacional duracion.
	 * 
	 * @return the terapia ocupacional duracion
	 */
	...
	/**
	 * Gets the terapia ocupacional sesiones.
	 * 
	 * @return the terapia ocupacional sesiones
	 */
	 ...
	 */
	public void setAyudasMarcha(Integer ayudasMarcha) {
	 ...
	 */
	public void setOrtesisDiurna(Integer ortesisDiurna) {
	...
	public void setOrtesisNocturna(String ortesisNocturna) {
		OrtesisNocturna = ortesisNocturna;
	}
	...
	/**
	 * Sets the terapia ocupacional duracion.
	 * 
	 * @param terapiaOcupacionalDuracion
	 *            the new terapia ocupacional duracion
	 */
	...
	/**
	 * Sets the terapia ocupacional sesiones.
	 * 
